...
var vnode = (0, _snabbdom.h)("div#container.cls", "Hello Wrold");
var app = document.querySelector("#app"); // 第一个参数：旧的VNode,h或 DOM 元素
// 第二个参数：新的 VNode
// 返回新的 VNode

var oblVnode = patch(app, vnode);
vnode = (0, _snabbdom.h)("div#container.xxx", "Hello Snabbdom");
