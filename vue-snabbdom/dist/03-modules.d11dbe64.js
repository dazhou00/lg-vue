...
// 1. 导入模块
// 2. 注册模块
var patch = (0, _snabbdom.init)([_snabbdom.styleModule, _snabbdom.eventListenersModule]); // 3. 使用 h() 函数的第二个参数传入模块中使用的数据（对象）

var vnode = (0, _snabbdom.h)("div", [(0, _snabbdom.h)("h1", {
  style: {
    backgroundColor: "red"
  }
}, "Hello Wrold"), (0, _snabbdom.h)("p", {
  on: {
    click: eventHandler
  }
}, "Hello p")]);
